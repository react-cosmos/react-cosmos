...
A screen size can be embedded into a fixture using the [`<Viewport>`](fixtures/ui-controls.md#viewport) decorator.
...
| Custom       | Defined using [custom fixture hooks](fixtures/ui-controls.md) that can be represented as text inputs or select dropdowns. |
...
The Cosmos UI can be extended using [UI Plugins](/docs/plugins/ui-plugins.md).

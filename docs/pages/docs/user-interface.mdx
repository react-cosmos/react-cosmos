...
The preview background color can be customized using the `ui.rendererPreview.iframeBgColor` setting in the [Cosmos config](/docs/configuration/cosmos-config.md). For a more dynamic background configuration use a global [Decorator](/docs/fixtures/decorators.md).

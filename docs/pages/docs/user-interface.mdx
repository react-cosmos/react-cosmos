...
<Image
  ...
  height={400}
  className="screenshot"
  src="/screenshots/fixture-search.png"
/>
...
The preview background color can be customized using the `ui.rendererPreview.backgroundColor` setting in the [Cosmos config](/docs/configuration/cosmos-config.md). For a more dynamic background configuration use a global [Decorator](/docs/fixtures/decorators.md).
...
> **Note** You need to install the [Open Fixture Plugin](/docs/plugins.md#open-fixture-plugin) to enable this capability.

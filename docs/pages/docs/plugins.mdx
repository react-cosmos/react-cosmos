...
This combines a [server plugin](/docs/plugins/server-plugins.md) with a [UI plugin](/docs/plugins/ui-plugins.md). It adds a renderer action that opens the selected fixture file in your default editor.
...
This is a [UI plugin](/docs/plugins/ui-plugins.md) that turns boolean inputs in the [Control Panel](/docs/user-interface.md#control-panel) from a true/false button to a checkbox input.
...
- [react-cosmos-plugin-rspack](https://github.com/birchill/react-cosmos-plugin-rspack) — Rspack support for React Cosmos.
- [react-cosmos-dark-mode](https://github.com/birchill/react-cosmos-dark-mode) — Toggle between light and dark mode in the Cosmos UI.

...
This is a [UI plugin](ui-plugins.md) that turns boolean inputs in the [Control Panel](/docs/user-interface.md#control-panel) from a true/false button to a checkbox input.

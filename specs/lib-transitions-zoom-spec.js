var Cosmos = require('../build/cosmos.js'),
    translateRectPositionAndScale =
      Cosmos.transitions.Zoom.prototype._translateRectPositionAndScale;

describe("Zoom transition", function() {
  ...
  it("should zoom in to bottom-right corner", function() {
    ...
    expect(translateRectPositionAndScale(
    ...
    var translatedRect = translateRectPositionAndScale(

...
You might get this error when using a custom webpack config. There
are two methods for configuring the loader `index.html` page:

- Use [HTML Webpack Plugin.](https://github.com/ampedandwired/html-webpack-plugin)
- Use the `publicPath` option to use your existing index.html. Details below.

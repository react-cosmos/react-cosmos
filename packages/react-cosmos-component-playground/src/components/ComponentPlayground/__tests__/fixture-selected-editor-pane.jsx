...
describe('CP selected with fixture editor pane open', () => {
  ...
  describe('default size', () => {
    ...
    test('should render selected fixture editor button', () => {
      expect(
  ...
  describe('cached size', () => {
    ...
    it('should render DragHandle in fixture editor pane', () => {
      expect(wrapper.find('.fixtureEditorPane').find(DragHandle).length).toBe(
        1
      );
    });
  ...
  describe('on drag', () => {
    ...
    it('should resize left nav', () => {
      expect(wrapper.find('.fixtureEditorPane').prop('style').width).toBe(201);
    });

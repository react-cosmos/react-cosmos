...
export const BlankCanvasIllustration = () => (
  <Illustration viewBox="0 0 998.95 833.99">
    ...
    <polygon
      ...
      opacity="0.1"
    />
    <rect x="599.77" y="392.2" width="21.07" height="7.93" fill="#b77b7f" />
    <polygon
    ...
    <path
      ...
      fill="#dda2a6"
    />
    <rect x="602.75" y="88.07" width="11.06" height="5.97" opacity="0.1" />
    <path
      d="M718.67,125.56v21.66H699V125.56a2.68,2.68,0,0,1,2.69-2.69H716A2.69,2.69,0,0,1,718.67,125.56Z"
      transform="translate(-100.52 -33.01)"
      fill="#dda2a6"
    />
    <circle cx="608.28" cy="103.61" r="4.18" opacity="0.1" />
    <circle cx="608.28" cy="102.71" r="4.18" fill="#b77b7f" />
    <rect x="598.42" y="111.53" width="19.73" height="2.69" opacity="0.1" />
    <rect x="590.35" y="115.12" width="35.87" height="5.98" opacity="0.1" />
    <rect x="590.35" y="113.32" width="35.87" height="5.98" fill="#dda2a6" />
    <path
    ...
    <polygon
      ...
      opacity="0.1"
    />
    <rect x="599.77" y="392.2" width="21.07" height="3.29" opacity="0.1" />
    <polygon
    ...
    <path
      ...
      fill="#efb7b9"
    />
    <circle cx="387.68" cy="206.09" r="34.52" fill="#efb7b9" />
    <path
    ...
    <polygon
      ...
      fill="#9d9cb5"
    />
    <circle cx="179.99" cy="124.52" r="31.5" fill={fillColor} opacity="0.1" />
    <circle cx="113.99" cy="49.52" r="19.5" fill={fillColor} opacity="0.1" />
    <circle cx="12" cy="93.02" r="12" fill={fillColor} opacity="0.1" />
  </Illustration>
);

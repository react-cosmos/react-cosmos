...
export const DreamerIllustration = ({ title }: { title: string }) => (
  <Illustration viewBox="0 0 1188 795.33">
    <defs>
      <linearGradient
      ...
      >
        <stop offset="0" stopColor={deprecated_primary4} />
        <stop offset="1" stopColor={deprecated_grey2} />
      </linearGradient>
      <linearGradient
    ...
    <path
      ...
      transform="translate(-6 -52.33)"
      fill="none"
      stroke={deprecated_grey1}
      strokeMiterlimit="10"
      strokeWidth="4"
    />
    <circle cx="1092.72" cy="471.38" r="28" fill={deprecated_grey1} />
    <circle cx="1142.21" cy="518.05" r="28" fill={deprecated_grey1} />
    <circle cx="1093.46" cy="583.54" r="28" fill={deprecated_grey1} />
    <circle cx="1107.7" cy="652.29" r="28" fill={deprecated_grey1} />
    <path
      ...
      strokeWidth="4"
    />
    <circle cx="825.72" cy="415.38" r="28" fill={deprecated_grey1} />
    <circle cx="875.21" cy="462.05" r="28" fill={deprecated_grey1} />
    <circle cx="826.46" cy="527.54" r="28" fill={deprecated_grey1} />
    <circle cx="840.7" cy="596.29" r="28" fill={deprecated_grey1} />
    <path
      ...
      transform="translate(-6 -52.33)"
      fill="none"
      stroke={deprecated_grey2}
      strokeMiterlimit="10"
      strokeWidth="4"
    />
    <circle cx="401.12" cy="466.08" r="11.81" fill={deprecated_grey2} />
    <circle cx="411.73" cy="492.74" r="11.81" fill={deprecated_grey2} />
    <circle cx="381.43" cy="509.1" r="11.81" fill={deprecated_grey2} />
    <circle cx="374.63" cy="537.92" r="11.81" fill={deprecated_grey2} />
    <path

React Cosmos uses the beautiful [Feather icon set](https://feathericons.com/). All SVGs are placed in this directory for convenience, but only used icons are bundled.
